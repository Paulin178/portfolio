...
<div class="flex min-h-screen w-screen flex-col bg-gradient-to-l from-slate-0 to-white-900">
  ...
  <div class="lg:w-1/2 lg:pr-8">
    <div class="">
    <a href="../php/snake.php" target="_blank">
    <link rel="shortcut icon" href="../images/fox.png">
    <button class="cta">
    <span class="span">Jouer</span>
    </a>
    <span class="second">
...
<br><br>
    <div class="mt-4">
      <h2 class="text-3xl font-medium text-gray-700">Jeu du snake</h2>
      <p class="mt-6 text-gray-600">
      Le but du jeu est de faire manger les plus de pommes (en rouge) à votre serpent pour le faire grandir. 
    </div>
  </div>
  <div class="-order-1 mb-8 lg:order-1 lg:mb-0 lg:w-1/2">
    <img class="border-blue-600/10 rounded-3xl border shadow-md" src="../images/serpent.jpg" alt="" />
  </div>
</section>
...
<section class="mx-auto my-10 flex max-w-xl flex-col rounded-3xl border p-4 sm:px-16 sm:py-16 lg:max-w-screen-lg lg:flex-row">
  <div class="lg:w-1/2 lg:pr-8">
    <div class="">
    <a href="../php/morpion.php" target="_blank">
    <link rel="shortcut icon" href="../images/fox.png">
    <button class="cta">
    <span class="span">Jouer</span>
    </a>
...
<br><br>
    <div class="mt-4">
      <h2 class="text-3xl font-medium text-gray-700">Jeu du morpion</h2>
      <p class="mt-6 text-gray-600">
      Le but du jeu est d'aligner avant son adversaire 3 symboles identiques horizontalement, verticalement ou en diagonale.
    </div>
  </div>
  <div class="-order-1 mb-8 lg:order-1 lg:mb-0 lg:w-1/2">
    <img class="border-blue-600/10 rounded-3xl border shadow-md" src="../images/morpion3.png" alt="" />
  </div>
</section>
