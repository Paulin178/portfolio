...
<form method="post" class="form" action="signup.php">
    ...
    <span class="subtitle">Créer un compte en remplissant les champs ci-dessous</span>
    <div class="form-container">
                <p>Nom:</p><input type ="text" class="input" name="name" placeholder="name"/><br>
                <p>Prénom:</p><input type ="text" class="input" name="firstname"placeholder="firstname"><br>
                <p>Pseudo:</p><input type ="text" class="input" name="pseudo"placeholder="pseudo"><br>
                <p>Email:</p><input type ="text" class="input" name="email"placeholder="email"><br>
                <p>Mot de passe:</p><input type ="text" class="input" name="password"placeholder="password"><br><br>
                <button>Envoyer</button><br><br>
</div>
</form>
<div class="form-section">
  <p>Avez vous un compte? <a href="../php/connexion.php">Se connecter</a> </p>
</div>
</div>
</body>
