...
<br><br>
    <div class="mt-4">
      <h2 class="text-3xl font-medium text-gray-700">Jeux du serpent</h2> <br><br>
  <div class="-order-1 mb-8 lg:order-1 lg:mb-0 lg:w-1/2">
    <img class="border-blue-600/10 rounded-3xl border shadow-md" src="../images/snake.jpg" alt="" />
  </div>
  </section>
...
<br><br>
<div class="mt-4">
      <h2 class="text-3xl font-medium text-gray-700">Jeux du morpion</h2> <br><br>
  <div class="-order-1 mb-8 lg:order-1 lg:mb-0 lg:w-1/2">
    <img class="border-blue-600/10 rounded-3xl border shadow-md" src="../images/morpion.png" alt="" />
  </div>
