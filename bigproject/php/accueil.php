    ...
    <div class="flex flex-col items-center justify-between lg:flex-row">
      <div class="mb-10 lg:mb-0 lg:max-w-lg lg:pr-5">
        <div class="mb-6 max-w-xl">
          ...
          <p class="text-base text-black-200">Je suis étudiant en première année de Bachelor Développeur Informatique Option Cybersécurité. <br>A la suite de mon Bachelor, je souhaite m'orienter vers un Master Of Science Expert en Cybersécurité. <br>
